...
class App extends Component {
  ...
  renderSideNavBar() {
    const ulNave = cx({
      ...
      [styles["text-center"]]: true,
    });
    const aNav = cx({
      [styles["nav-link"]]: true,
      [styles["brand-logo"]]: true,
      [styles["text-white"]]: true,
    });
    return (
      <div id="main" className={styles["d-flex"]}>
        <aside className={styles["primary-nav"]}>
          <ul className={ulNave} id="typeNav" role="tablist">
